...
type Parser struct {
	...
	curToken  token.Token // current position token -- like position in lexer
	peekToken token.Token // peeking position of token -- like readPosition in lexer
